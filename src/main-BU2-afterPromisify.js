...
Apify.main(async () => {
    ...
    const getBalance = util.promisify(anticaptcha.getBalance);
    const createGeeTestTask = util.promisify(anticaptcha.createGeeTestTask);
    const getTaskSolution = util.promisify(anticaptcha.getTaskSolution);
    ...
    const taskSolution = await getTaskSolution(taskId);
